...
CBS_BIOraw <- read_csv("../data/raw/CBS_practiceSummary_BIO.csv") %>%
  mutate(practice = "CBS",
         pID = FBndID,
         IWAP = 2,
         ...
         energyPot_kWh = energyPot * 277.778, ## GJ to kWh
...
## crop acres = all cropped acres within the drainage area of the practice.
NRW_BIOraw <- read_csv("../data/raw/NRW_practiceSummary_BIO.csv") %>%
  mutate(practice = "NRW",
         pID = SiteID,
         IWAP = 0,
...
PCP_BIOraw <- read_csv("../data/raw/PCP_practiceSummary_BIO.csv") %>%
  mutate(practice = "PCP",
         pID = FBndID,
         IWAP = 1,
         INRS = "Perennial crops",
...
## crop acres = all cropped acres within the drainage area of the practice.
STB_BIOraw <- read_csv("../data/raw/STB_practiceSummary_BIO.csv") %>%
  mutate(practice = "STB",
         pID = riparianid,
         IWAP = 2,
...
## crop acres = field acres
WCR_BIOraw <- read_csv("../data/raw/WCR_practiceSummary_BIO.csv") %>%
  mutate(practice = "WCR",
         pID = FBndID,
         IWAP = 0,
